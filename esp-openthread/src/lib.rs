...
use sys::bindings::{
    ...
    otSecurityPolicy, otSetStateChangedCallback, otTaskletsArePending,
    otTaskletsProcess, otThreadGetDeviceRole, otThreadSetChildTimeout, otThreadSetEnabled,
    otTimestamp, OT_NETWORK_NAME_MAX_SIZE,
};
