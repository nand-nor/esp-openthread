...
use crate::{get_settings, platform::CURRENT_INSTANCE, set_settings, with_radio, NetworkSettings, TASKLETS_SHOULD_RUN};
...
pub(crate) fn trigger_tx_done() {
    ...
    critical_section::with(|_cs| {
        ...
        unsafe {
            ...
            rtt_target::rprintln!("Platform tx done");
